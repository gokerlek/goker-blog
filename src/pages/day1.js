...
export const Day1 = () => {
  return (
    <div className="day1">
      ...
      <p>I have installed NVM by running the following command on the terminal</p>
      <Code>
      ...
      <p>I downloaded the NodeJs latest version by entering the command below.</p>
      <Code>nvm install v15.8.0</Code>
      <p>I entered the following commands to check</p>
      <Code>npm -v</Code>
      <Code>node-v</Code>
      <p>
        To create a Goker Blog project file, it is necessary to enter the projects
        file. I created my file in the projects folder by entering the commands
        below.
      </p>
      <Code>cd projects</Code>
      <Code>npx create-react-app goker-blog</Code>
      <p>
        To install the default react app in the goker blog file, go to the following
        command
      </p>
