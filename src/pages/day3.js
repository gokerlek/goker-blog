...
export default App;`}
      ...
      <p>
        ...
        way, the web page will not be refreshed over and over again when switching
        between pages.
      </p>
      <Code>
        {`const App = () => {
  ...
  <div className = "layout">
    ...
    <Footer />
      ...
      <p>
        ...
        file will appear on the main page. For this reason, we will import it into
        home.js. We will link the Day2 file into the Day1 file. Below is the final
  ...
  return <div>
    <Day1 />
      ...
      <p>
        ...
        just like container.js file. We also created the code.css file. T his way,
        wherever we do the code structure, it will appear as code.css. I n addition,
        we need to use the Link structure to run a link with the react router. Let's
        replace the "a href" structure in the header and footer with the "link"
